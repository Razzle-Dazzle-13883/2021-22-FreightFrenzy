 ...
 * is explained below.
 */
@TeleOp(name = "TensorFlow Object Detection Webcam")
public class WebcamAuto extends LinearOpMode {
   ...
   */
    ...
    //Duck On level 1
    public void level1() {
        telemetry.addData("Status", "level 1");
        telemetry.update();
    ...
    //Duck on level 2
    public void level2() {
        telemetry.addData("Status", "level 2");
        telemetry.update();
    ...
    //Duck on Level 3
    public void level3() {
        telemetry.addData("Status", "level 3");
        telemetry.update();
